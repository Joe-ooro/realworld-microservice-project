...
pipeline{
        ...
        stage('ZAP Dynamic Testing | DAST') {
            steps {
                sshagent(['OWASP-Zap-Credential']) {
                    sh 'ssh -o StrictHostKeyChecking=no ubuntu@13.58.208.218 "docker run -t owasp/zap2docker-stable zap-baseline.py -t http://18.191.244.71:30000/" || true'
    ...
    always {
        ...
        slackSend channel: '#wednesday-devsecops-cicd-alerts', //update and provide your channel name
